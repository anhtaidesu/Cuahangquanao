...
<title>
<?php 
if(!isset($_REQUEST['trangchuyen']))
	echo "Trang Quản Trị Cửa Hàng Quần Áo";
else
	echo "Shopquanao99kk"; 
?>
</title>
	...
	<table border="0" cellpadding="0" cellspacing="0" width="960" align="center" style="margin-top:20px; margin-bottom:20px; background:#FFFFFF;">
		<tr>
			<td height="40" style="color:#FFFFCC; background:#66A111;" colspan="2" align="center">
			 QUẢN LÝ - shopquanao99kk.000webhostapp.com
			</td>
		</tr>
		<tr>
		...
		<tr>
			...
			<div class="menuleft">
					<a href="#" onclick="adm_chuyentrang('quanlyloaicay')">Quản Lý Loại Quần Áo</a>
			...
			background:#FFFFFF; color:#999999; text-align:left; border-right:none; border-left:none;">
					<a href="#" onclick="adm_chuyentrang('quanlyloaicay')">
                    <span class="demuc"> Tổng Số Danh Mục <?php echo $soloaiqua; ?> </a>
					<br />
                    <a href="#" onclick="adm_chuyentrang('quanlycay')">
					<span class="demuc">Tổng Số Quần Áo:</span> <?php echo $soqua; ?></a>	
					<br />
                    <a href="#" onclick="adm_chuyentrang('quanlykhachhang')">
					<span class="demuc">Số Khách Hàng:</span> <?php echo $khachhang; ?></a>
					<br />
                    <a href="#" onclick="adm_chuyentrang('quanlytintuc')">
					<span class="demuc">Số Tin Tức:</span> <?php echo $tintuc; ?> </a>
					<br />
                    <a href="#" onclick="adm_chuyentrang('quanlylienhe')">
					<span class="demuc">Số Góp Ý:</span> <?php echo $lienhe; ?></a>
					<br />
                    <a href="#" onclick="adm_chuyentrang('quanlydondathang')">
					<span class="demuc">Số Đơn Đặt Hàng:</span> <?php echo $dondathang; ?> </a>
				</div>
			</td>
			<td width="760" valign="top">
					...
					if(isset($_POST['trangchuyen']))
					{
						...
						if($hienthi=='quanlyloaicay')
							include_once('loaiqua/loaiqua.php');
						else if($hienthi=='quanlycay')
		...
		<tr>
			...
			Copyright © shopquanao99kk.000webhostapp.com. 
			</td>
		</tr>
	</table>
