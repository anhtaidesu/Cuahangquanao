		...
		<td>
		  <form name="themtintuc" method="post" action="">
			  ...
			  <tr>
                <td>&nbsp;&nbsp;Tác giả</td>
                <td>
                  <input name="tacgia" type="text" id="tacgia" maxlength="50" style="width:300px;" 
				  	value="<?php echo $rowTT['tacgia']; ?>">
                </td>
              </tr>
              <tr>
                <td>&nbsp;&nbsp;Ảnh Minh Họa</td>
			  ...
			  <tr>
                <td>&nbsp;&nbsp;Nội dung ngắn</td>
                <td>
                  <textarea name="noidungngan" cols="68" rows="5" id="noidungngan"><?php echo $rowTT['noidungngan']; ?></textarea>
