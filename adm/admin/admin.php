...
?>
	<p class='pp'>
		<center>Bạn Không Đủ Quyền Quản Lý Mục Này
			<br />
			<a href="index.php">Bấm Vào Đây Để Quay Lại Trang Chủ!</a>
		</center>
	</p>
<?php
} else {
...
?>
	...
	<table width="750" cellpadding="2" cellspacing="0" border="0" class="admintable" style="border-right:#E9E9E9 1px solid; border-top:#E9E9E9 1px solid;" align="right">
		...
		<?php $i = 0; ?>
		<?php while ($rowADM = mysqli_fetch_array($admin)) {
			$i += 1; ?>
			<tr>
				<?php
				//xu ly mau cho dong
				...
				<td width="100" align="center" <?php echo $mausac; ?>>
					<a href="#" onclick="alert('Ban ko the xoa ')" style="color:#999">Xóa</a>
				</td>
			</tr>
		<?php } ?>
