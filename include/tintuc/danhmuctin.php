          ...
          <table width="587" cellpadding="0" cellspacing="0" border="0" style="border:#CCCCCC 1px solid; margin-top:3px;">
            <tr>
              <td><a href="#" onclick="chitiet_tt('<?php echo $rowTINMOI['ma_tt']; ?>')"> <img src="images/tintuc/<?php echo $rowTINMOI['hinh_anh'] ?>" width="150" height="90" 
                  ...
                  <p class="pp"> <a href="#" onclick="chitiet_tt('<?php echo $rowTINMOI['ma_tt']; ?>')"><b><?php echo $rowTINMOI['tieu_de'] ?></b></a> 
				  <br />
                      <?php echo $rowTINMOI['tacgia']?> 
				  <br />
                      <?php echo $rowTINMOI['noidungngan']?>...<br>         
