<?php
	...
	$ma=$_POST['MaLH'];
		...
		$strSQLH="SELECT * FROM loai_hang WHERE ma_loai={$ma}";
		$hienthiloai=mysqli_query($ung,$strSQLH);
							...
							<table width="437" cellpadding="0" cellspacing="0" border="0">
								<tr> 
									<td height="20" align="center">
										...
										Tên Sản Phẩm:</span> 								
										<span class="ten">
										<a href="#" onclick="chitiet('<?php echo $row['ma_hang']; ?>')"><b><?php echo $row									                                         ['ten_hang']; ?></b></a>
										</span>
												...
												?>
										<br />
										<span class="demuc">Giá Bán:</span><?php echo number_format($row['gia'],0,'.','.'); ?> VNĐ
										<br>
										<span class="demuc">Số Lượng:</span><?php echo number_format($row['so_luong'],0); ?> Chiếc
									</td>
								</tr>
								<tr>
									<td align="left">
