						...
						<td>
						  ...
						  <table width="450" border="0" align="center" cellpadding="3" cellspacing="0" class="dongbang" style="border-top:#CCCCCC 1px solid;border-right:#CCCCCC 1px solid; margin-top:10px; margin-bottom:10px;">
							...
							<tr>
                              <td>&nbsp;&nbsp;Họ </td>
                              <td>
							  <input name="ho" type="text" id="ho" style="width:200px;"
							  value=""/>
							  <br /><span id="loiho" style="color:#FF6600;"></span>
                              </td>
                            </tr>
							...
							<tr>
                              <td>&nbsp;&nbsp;Tên </td>
                              <td>
							  <input name="ten" type="text" id="ten" style="width:200px;"
							  value=""/>
                            ...
                            <tr>
                              <td>&nbsp;&nbsp;Địa Chỉ Nhà </td>
                              <td>
                    <textarea name="diachi" cols="31" rows="3" id="diachi" style="border-right:none;width:200px"> </textarea>
